    ...
    try:
        ...
        if(redis_con.exists(cache_key)):
            ...
            #se os valores não forem iguais, então é uma fraude.
                ...
                #Coloca a saida com a URL
                url = minio_conn.presigned_get_object(bucket_name, file_name, expires=timedelta(minutes=2))
...
channel.basic_consume(queue="queue_antifraude", 
